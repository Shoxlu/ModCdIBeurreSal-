{
    ...
    binhacks: {
        hook_window_creation_ends: {
            addr: "0x473135",
            code: "E9 [codecave:pobh.text0+0xbd0]",
        },
        hook_sanae_bomb: {
            addr: "0x4184EF",
            code: "E8 [codecave:pobh.text0+0x7b0]",
        },
        ...
        Sanae_bomb_hook_on_tick: {
            addr: "0x4186D2",
            code: "E8 [codecave:pobh.text0+0x1e0] 5D C3",
        },
